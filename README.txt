...
To see a demonstration of the the program's functionality, change the setting "FILE_NAME" in
    "settings.py" to "Canadian Stocks"
...
Settings may be changed within the file "settings.py". Simply redefine variables with desired
    values